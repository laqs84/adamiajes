...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>Niveles de las Competencias</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="box box-info">
                                    ...
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <form id="form-creacion" action="competenciasniveles" method="post" class="form-horizontal" accept-charset="UTF-8" pjax-container="">
                                        @csrf <!-- {{ csrf_field() }} -->
                                        <div class="box-body">
                                            ...
                                            <div class="fields-group">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group  ">
                                                        ...
                                                        <label for="tipo_comp" class="col-sm-2  control-label">Valor esperado</label>

                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="val_nivdom" name="val_nivdom">
                                                        </div>
                                                    </div>
...
function eliminar(elemento) {
    ...
    $.ajax(
            {
                url: "/admin/competenciasniveles/delete/" + id,
                type: 'DELETE',
                dataType: "JSON",
                data: {
                    "id": id
...
function detalle(elemento) {
    ...
    $("#val_nivdom").val($($($(elemento).parent().parent())[0]).find("td").eq(1).html());
