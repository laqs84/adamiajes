                            ...
                            <div class="col-md-12">
                                ...
                                <div class="box box-info">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Prueba para:</h3>
                                    ...
                                    <form id="form-creacion" action="personas_pruebas" method="post" class="form-horizontal" accept-charset="UTF-8" pjax-container="">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="fields-group">
                                                ...
                                                <div class="col-md-12">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <h2 name="nombre" id="nombre"   value="{{$nombre}}">{{$nombre}}</h2>
                                         ...
                                         <input type="hidden" id="random_pru" name="random_pru" value="{{$random_pru}}">                                            
                                                        ...
                                                        <div class="col-sm-6">
                                                            <h4 name="puesto" id="puesto"   placeholder="Puesto" value="{{$puesto}}">{{$puesto}}</h4>
                                                  ...
                                                  <div class="col-md-12">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <h5 name="fecha_actual" id="fecha_actual" type="text"   placeholder="Fecha de prueba" value="<?php echo date('d/m/Y');?>"><?php echo date('d/m/Y');?></h5>
                                                        </div>

                                              

                                                        <div class="col-sm-6">
                                                            <h5 type="text" id="tiempo_limite" name="tiempo_limite" value="{{$tiempo_limite}}">Tiempo límite: {{$tiempo_limite}}</h5>
                                                        </div>
...
@endif  
                ...
                <div>
<img src="{{URL::asset('/img/pieandamiajes.jpeg')}}" alt="profile Pic" width="1000">                
                </div>
 <script>
        ...
        for (const key in sessionStorage) {
          ...
          $.ajax({
            ...
            success: function(response){
                ...
                h.innerHTML = "Prueba fue enviada. Gracias!!";
                $("#descripcion").show();          
                ...
                b = document.getElementById("butcon");
                b.style.display = "none";         
                b = document.getElementById("instrucciones");
                b.style.display = "none";                    
      });

      $('#sigacc').click(function(){
        var id = $('#con_test').val();
        var id2 = $('#numsec_prueba').val();
        $("#instrucciones").hide();
        $("#desc_titel").hide();
        t = document.getElementById("tabla");
...
if(numchecks==0){
    ...
    // return;
            ...
            if(finaliza==1){
              ...
              var id = $('#random_pru').val();
          $.ajax({
            url: 'getNextTest/'+id+"/"+listtest,
            type: 'get',
            dataType: 'json',
            success: function(response){
             ...
             // $('#opciones').empty();
              ...
              if(response.data.con_test == 0){
                h = document.getElementById("desc_titel");
                h.innerHTML = "Ha finalizado la prueba. Gracias!!";
                h = document.getElementById("desc_instruc");
