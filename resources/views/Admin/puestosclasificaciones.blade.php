...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>Clasificacion de los Puestos</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="box box-info">
                                    ...
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <form id="form-creacion" action="puestosclasificaciones" method="post" class="form-horizontal" accept-charset="UTF-8" pjax-container="">
                                       {{ csrf_field() }}
                                        <div class="box-body">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group  ">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input type="hidden" id="con_clapue" name="con_clapue">
                                                        </div>
                                                    </div>
...
function eliminar(elemento) {
    ...
    $.ajax(
            {
                url: "/admin/puestosclasificaciones/delete/" + id,
                type: 'DELETE',
                dataType: "JSON",
                data: {
                    "id": id
