...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>Pruebas de las Empresas</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="box box-info">
                                    ...
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <form id="form-creacion" action="empresaspruebas" method="post" class="form-horizontal" accept-charset="UTF-8" pjax-container="">
                                        @csrf <!-- {{ csrf_field() }} -->
                                        <div class="box-body">
                                            ...
                                            <div class="fields-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group  ">
                                                        ...
                                                        <label for="con_emp" class="col-sm-2  control-label">Empresa</label>
