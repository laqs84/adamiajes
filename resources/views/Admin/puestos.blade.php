                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="box box-info">
                                    ...
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <form id="form-creacion" action="puestos" method="post" class="form-horizontal" accept-charset="UTF-8" pjax-container="">
                                        @csrf <!-- {{ csrf_field() }} -->
                                        <div class="box-body">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group  ">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input type="hidden" id="con_pue" name="con_pue">
                                                        </div>
                                                    </div>
                                                    <div class="form-group  ">

                                                        <label for="tipo_comp" class="col-sm-2  control-label">Clasificacion de los Puestos</label>

                                                        <div class="col-sm-8">
                                                            <select class="form-control" style="width: 100%;" id="con_clapue" name="con_clapue"  tabindex="-1" aria-hidden="true">
                                                                @foreach($puestosClasificacion as $item)
                                                                <option value="{{$item->con_clapue}}">{{$item->descripcion}}</option>
                                                                @endforeach
                                                            </select>
                                                            
                                                        </div>
                                                        <button onclick="puestosclasificaciones()" type="button"><i class="fa fa-search"></i></button>
                                                    </div>
                                    ...
                                    <div class="box-body">
                                        <table id="competencias" class="table table-striped table-bordered" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>Descripción</th>
                                                    <th>Clasificacion de los Puestos</th>
                                                    <th>Acciones</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($puestos as $id=>$json)
                                                <tr>
...
function detalle(elemento) {
    ...
    $("#con_clapue").find('option:contains("'+$($($($(elemento).parent().parent())[0]).find("td").eq(1)[0]).text()+'")').prop('selected', true);
    $(".box-title, .btn-accion").text("Editar");
    $("#con_pue").val(id);
}
function puestosclasificaciones() {
    document.location.href = '/admin/puestosclasificaciones';
}
        </script>
            </div>
