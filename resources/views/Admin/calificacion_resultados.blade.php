                                            ...
                                            <div class="fields-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group  ">
                                                        ...
                                                        <label for="predominancia_resultado" class="col-sm-2  control-label">Predominancia del Resultado</label>

                                                        <div class="col-sm-8">
                                                            <textarea name="predominancia_resultado" id="predominancia_resultado" class="form-control predominancia_resultado" rows="5" placeholder="Predominancia Resutaldo"></textarea>
                                                            <input type="hidden" id="con_comp" name="con_comp">
                                                        </div>
                                                    </div>
                                                    <div class="form-group  ">

                                                        <label for="tipo_comp" class="col-sm-2  control-label">Tipo de Competencia</label>
